...
class EShopControllerExports extends JControllerLegacy
{
	...
	function _exportProducts()
	{
		...
		$exportFormat	= JRequest::getVar('export_format', 'csv');
		$db = JFactory::getDbo();
	...
	function _exportOrders()
	{
		...
		$orderIdFrom = JRequest::getVar('order_id_from', 0);
		$orderIdTo = JRequest::getVar('order_id_to', 0);
		$listOrderId = JRequest::getVar('list_order_id', '');
		$fieldDelimiter = JRequest::getVar('field_delimiter', ',');
		$db = JFactory::getDbo();
	...
	function _exportGoogleFeed()
	{
		...
		$fieldDelimiter					= $input->get('field_delimiter', ',', 'string');
		$language						= $input->get('language', 'en-GB');
		$removeZeroPriceProducts		= $input->get('remove_zero_price_products', '0');
		$removeOutOfStockProducts		= $input->get('remove_out_of_stock_products', '0');
		$googleId						= $input->get('google_id', '1');
		$googleTitle					= $input->get('google_title', '1');
		$googleDescription				= $input->get('google_description', '1');
		$googleProductType				= $input->get('google_product_type', '1');
		$googleLink						= $input->get('google_link', '1');
		$googleMobileLink				= $input->get('google_mobile_link', '1');
		$googleImageLink				= $input->get('google_image_link', '1');
		$googleAdditionalImageLink		= $input->get('google_additional_image_link', '1');
		$googleAvailability				= $input->get('google_availability', '1');
		$googlePrice					= $input->get('google_price', '1');
		$googleSalePrice				= $input->get('google_sale_price', '1');
		$googleMpn						= $input->get('google_mpn', '1');
		$googleBrand					= $input->get('google_brand', '1');
		$googleShippingWeight			= $input->get('google_shipping_weight', '1');

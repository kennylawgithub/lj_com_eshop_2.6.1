	...
	<table width="100%">
		<tr>
			...
			<td align="left" width="15%">	
				<?php echo JHtml::_('calendar', JRequest::getVar('date_start', date('Y-m-d', strtotime(date('Y') . '-' . date('m') . '-01'))), 'date_start', 'date_start', '%Y-%m-%d', array('class' => 'input-small')); ?>
			</td>
			<td align="left" width="5%">	
				<?php echo JText::_('ESHOP_END_DATE')?>:
			</td>
			<td align="left" width="15%">	
				<?php echo JHtml::_('calendar', JRequest::getVar('date_end', date('Y-m-d')), 'date_end', 'date_end', '%Y-%m-%d', array('class' => 'input-small')); ?>
			</td>
			<td>	

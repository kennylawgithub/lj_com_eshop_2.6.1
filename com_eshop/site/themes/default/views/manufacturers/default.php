...
if (count($this->items)) 
{
	...
	?>
	<div class="eshop-manufacturers-list"><?php echo EshopHtmlHelper::loadCommonLayout('common/manufacturers.php', array ('manufacturers' => $this->items, 'manufacturersPerRow' => $this->manufacturersPerRow)); ?></div>
	<?php

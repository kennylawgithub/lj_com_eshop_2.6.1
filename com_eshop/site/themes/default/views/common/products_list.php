			...
			<div class="image img-polaroid">
				<a href="<?php echo $productUrl; ?>" class="product-image">
					...
					<img src="<?php echo $product->image; ?>"
					     ...
					     alt="<?php echo $product->product_page_title != '' ? $product->product_page_title : $product->product_name; ?>"/>
				</a>
			</div>
		</div>
		...
		<div class="eshop-buttons">
			...
			if (EshopHelper::isCartMode($product) || EshopHelper::isQuoteMode($product))
			{
				...
				<div class="eshop-cart-area">
					...
					if (EshopHelper::getConfigValue('show_quantity_box'))
					{
						...
						<div class="input-append input-prepend">
											<span class="eshop-quantity">
												<a class="btn btn-default button-minus" id="<?php echo $product->id; ?>"
												   data="down">-</a>
												<input type="text" class="eshop-quantity-value"
												       id="quantity_<?php echo $product->id; ?>" name="quantity"
												       value="1"/>
												<a class="btn btn-default button-plus" id="<?php echo $product->id; ?>"
												   data="up">+</a>
											</span>
						</div>
						<?php
					...
					{
						?>
						<input id="add-to-cart-<?php echo $product->id; ?>" type="button" class="btn btn-primary"
			...
			if (($product->product_quantity <= 0 && EshopHelper::getConfigValue('allow_notify')) || EshopHelper::getConfigValue('allow_wishlist') || EshopHelper::getConfigValue('allow_compare'))
			{
				...
				<p>
					...
					{
						?>
						<a class="btn button" style="cursor: pointer;"

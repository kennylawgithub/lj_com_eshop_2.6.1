	...
	<div id="email-a-friend-area">
		<form method="post" name="adminForm" id="adminForm" action="index.php" class="form form-horizontal">
			...
			<div class="control-group">
				<label class="control-label" for="sender_name"><span class="required">*</span><?php echo JText::_('ESHOP_SENDER_NAME'); ?>:</label>
			...
			<div class="control-group">
				<label class="control-label" for="sender_email"><span class="required">*</span><?php echo JText::_('ESHOP_SENDER_EMAIL'); ?>:</label>
				<div class="controls docs-input-sizes">
			...
			<div class="control-group">
				<label class="control-label" for="message"><span class="required">*</span><?php echo JText::_('ESHOP_SENDER_MESSAGE'); ?>:</label>
				<div class="controls docs-input-sizes">
			...
			<div class="control-group">
				<label class="control-label" for="invitee_name"><span class="required">*</span><?php echo JText::_('ESHOP_INVITEE_NAME'); ?>:</label>
				<div class="controls docs-input-sizes">
			...
			<div class="control-group">
				<label class="control-label" for="sender_email"><span class="required">*</span><?php echo JText::_('ESHOP_INVITEE_EMAIL'); ?>:</label>
				<div class="controls docs-input-sizes">
			...
			<input type="button" class="btn btn-primary pull-left" id="button-email-a-friend" value="<?php echo JText::_('ESHOP_SUBMIT'); ?>" />

...
<fieldset class="form-horizontal">
	...
	<div class="control-group">
		<div class="control-label">
			<?php echo EshopHtmlHelper::getFieldLabel('tax', JText::_('ESHOP_CONFIG_ENABLE_TAX')); ?>
		</div>
		<div class="controls">
	...
	<div class="control-group">
		<div class="control-label">
			<?php echo EshopHtmlHelper::getFieldLabel('display_ex_tax', JText::_('ESHOP_CONFIG_DISPLAY_EX_TAX')); ?>
		</div>
		<div class="controls">

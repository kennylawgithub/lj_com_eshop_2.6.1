...
<script type="text/javascript">
	...
	{
		var form = document.adminForm;
		var allAreaArr = ['field_delimiter_area', 'order_status_area', 'order_id_area', 'list_order_area', 'image_separator_area', 'language_area', 'google_feed_area'];
		if (form.export_type.value == '') {
			var areaArr = [];
		} else if (form.export_type.value == 'customers') {
			var areaArr = ['field_delimiter_area'];
		} else if (form.export_type.value == 'products') {
			var areaArr = ['field_delimiter_area', 'image_separator_area', 'language_area'];
			...
			var areaArr = ['field_delimiter_area', 'order_status_area', 'order_id_area', 'list_order_area', 'language_area'];
